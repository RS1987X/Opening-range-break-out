...
low_opening_rng_volume = (opening_rng_volume["Volume"].astype(int) < (1*200000)).to_frame()
...
pos_ind = dh_above_opening_high["High"] & low_opening_rng_volume["Volume"]
...
exit_price = exit_price.to_frame()
